...
const t = questTable();
ok('quests all map to real stats', t.every(q => ['houses','palms','flags','tallest','arcades','factories','plants','bpFinishedToday','tripsToday','goalsToday','sleptToday'].indexOf(q.need) !== -1));
