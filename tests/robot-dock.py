...
def run(pw, url, label, w, hgt):
    ...
    ck(label + ' PLAY is the huge hero', play and play['width'] >= 92 and play['height'] >= 92, play)
    ck(label + ' DREAM is the second hero', dream and dream['width'] >= 84 and dream['height'] >= 84, dream)
    ...
    ck(label + ' LOOK is a kid target', look and look['width'] >= 76 and look['height'] >= 76, look)
